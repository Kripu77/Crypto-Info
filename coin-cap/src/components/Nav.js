...
const Nav = () => {
  ...
  return (
    <nav>
      <section className="flex justify-between p-4 md:px-8 max-w-screen-xl mx-auto">
        <section>
          <Link to="/home">
            {" "}
            <Logo />
        ...
        >
          <section className="text-center   ">
            ...
            <section className=" replace sm:space-x-2 ">
              {!currentUser && (
                <button
                  className="hover:text-gray-200 hover:border-b-2"
                  onClick={() => navShow()}
                >
              ...
              <button
                className={show ? "fixed right-10 top-10 sm:hidden" : "hidden"}
                onClick={() => navShow()}
              >
                <ImCross />
              </button>
